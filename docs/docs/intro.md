...
Everything in a notebook is therefore there because someone put it there. Each account keeps its own courses, progress and graph, and nothing is pooled across an instance. An admin can open another person's knowledge graph and nothing else, which [Users and Admin](/self-hosting/users) covers.
...
| If you want to | Read |
| --- | --- |
| Set up an instance for the first time | [First run](/first-run) |
| Run Parcourse yourself | [Installing](/self-hosting/install) |
| Point it at a model | [Providers and models](/self-hosting/providers) |
| Look up a setting | [Configuration](/reference/configuration) |
| Work out why a video will not load | [Troubleshooting](/self-hosting/troubleshooting) |
