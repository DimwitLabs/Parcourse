...
The Parcourse logo is inspired from of the many potential `interrobang`s from the Inter font by Rasmus from [this GitHub thread](https://github.com/rsms/inter/issues/69#issuecomment-423794926).